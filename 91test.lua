...
local Window = Library.CreateLib("91 SA HUB V1.1b | TEST ｜ QQ群聊1047396923", "DarkTheme")
...
local Section = Tab:NewSection("其他")
...
Section:NewButton("加攻速test", "a", function()
loadstring(game:HttpGet("https://pastebin.com/raw/vfTkNR2M",true))()
    print("Clicked")
end)
...
--Section:NewSlider("人物速度", "SliderInfo", 500, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
   -- game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
--end)

--Section:NewSlider("跳跃高度", "Adjust your jump height", 500, 0, function(s)
...
local Tab = Window:NewTab("更新介绍")
local Section = Tab:NewSection("Made by 91")
local Section = Tab:NewSection("v1.1b更新功能，更简洁，boss和游戏脚本分开做")

Section:NewButton("点击这个或下面链接加群", ".", function()
    print("Clicked")
end)
